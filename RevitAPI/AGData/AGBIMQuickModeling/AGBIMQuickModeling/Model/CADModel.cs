...
namespace CADReader
{
    ...
    public class ScheduleDatas : INotifyPropertyChanged
    {
        ...
        private string key_5 = "Null";
        private string key_6 = "Null";
        private string key_7 = "Null";
        private string key_8 = "Null";
        private string key_9 = "Null";
        private string key_10 = "Null";
