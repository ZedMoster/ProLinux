...
namespace CADReader.Model
{
    class GetFloorTypeByName
    {
        ...
        /// 获取类型 FloorType
        /// </summary>
        public FloorType Get(Document doc, SelectElement selectElement)
        {
            ...
            UpdataColor(doc, floortype, selectElement);
            return floortype;
        }
        ...
        /// 更新类型厚度及材质参数
        /// </summary>
        private void UpdataColor(Document doc, FloorType floorType, SelectElement selectElement, double width = 150)
        {
